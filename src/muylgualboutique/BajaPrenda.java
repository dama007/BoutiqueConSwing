...
public class BajaPrenda extends javax.swing.JDialog {
    ...
    public BajaPrenda(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        articulos = MuylgualBoutique.misPrendas;
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "----Escoge un articulo----" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (articuloEscogido.equals(new Prenda())) {
            ...
            MuylgualBoutique.misPrendas.borrarRegistro(articuloEscogido);
